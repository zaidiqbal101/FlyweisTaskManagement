...
const employees = [
  {
    ...
    projects: [{ name: "Logo Design", timeline: "2025-10-18", client: "Client D" }],
  },
  {
    id: 7,
    name: "Grace",
    manager: "Sarah Connor",
    projects: [{ name: "Banner Graphics", timeline: "2025-10-22", client: "Client D" }],
  },
];
...
const GraphicsDesigners = () => {
  ...
  const totalDesigners = employees.length;
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-pink-600 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
                          {getInitials(e.name)}
                        </div>
        ...
        {filteredEmployees.length === 0 && (
          <div className="text-center py-12 bg-gray-50">
            ...
            <p className="text-gray-500 text-lg">No graphics designers found matching the search.</p>
          </div>
        )}
      </div>
    </div>
...
export default GraphicsDesigners;