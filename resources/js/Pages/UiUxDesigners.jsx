...
const employees = [
  {
    ...
    name: "Diana",
    manager: "Mike Ross",
    projects: [{ name: "Design Mockups", timeline: "2025-11-01", client: "Client C" }],
  },
  {
    id: 5,
    name: "Eve",
    manager: "Mike Ross",
    projects: [{ name: "User Flow Design", timeline: "2025-10-25", client: "Client C" }],
  },
];
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
                          {getInitials(e.name)}
                        </div>
        ...
        {filteredEmployees.length === 0 && (
          <div className="text-center py-12 bg-gray-50">
            ...
            <p className="text-gray-500 text-lg">No UI/UX designers found matching the search.</p>
          </div>
        )}
      </div>
    </div>
